...
var LIFP = {
	...
	/*isLegacyIE : {
    	...
    	return (browsVer && browsVer<=9) ? true : false;    	
	},*/
    ...
    createIFrame: function(page, msg, attr, nlc, rdt, dtp, sigID, status) {
    if(msg && msg != '') {
    ...
    if (sigID!=null&&(typeof(sigID) != 'undefined')&&sigID!='') {
      ...
      var htmlContent = '<style type="text/css">.login_scrim_wrapperLifp{opacity:1;display:table;position:fixed;height:100%;width:698px;left:50%;margin-left:-348px;top:0;z-index:9999999}.login_scrim_innerLifp{display:table-cell;vertical-align:middle}.login_scrim_moduleLifp{width:678px;line-height:1.15em;margin-left:10px}blockquote,body,dd,div,dl,dt,fieldset,form,h1,h2,h3,h4,h5,h6,input,li,ol,p,pre,td,textarea,th,ul{margin:0;padding:0}div,table,td{font-size:1em}body{text-align:left;font-family:Arial,Helvetica,sans-serif;font-size:62.5%;line-height:1;color:#000}.login_scrim_moduleLifp .headerStrapLifp{height:14px;padding:12px 12px 0;position:relative;z-index:101;width:100px;float:right}.login_scrim_moduleLifp a.closeBtnLifp{float:right;padding-right:16px;background:url(https://id.wsj.com/access/pages/wsj/us/img/icon_close-single.gif) right 1px no-repeat;font-size:1.1em;color:#486481;line-height:1.1em}.login_scrim_moduleLifp a,.login_scrim_moduleLifp a:link,.login_scrim_moduleLifp a:visited{color:#264374}a:active,a:link,a:visited{color:#093d72;text-decoration:none;outline:0}.login_scrim_framedLifp{display:block;border:none;padding:0;width:678px;position:relative;z-index:100;top:-26px}</style><div id="overlayDiv" class="login_scrim_wrapperLifp" style="opacity: 1; "><div id="login_inner" class="login_scrim_innerLifp">     <div id="module" class="login_scrim_moduleLifp"><div id="iframe_headerStrap" class="headerStrapLifp"><a href="javascript:LIFP.closeScrim();" class="closeBtnLifp iframeOverlayCloseBtnLifp" id="closeButton">close</a></div><iframe id="lifp_iframe"  name="lifp_iframe" scrolling="no" frameborder="0" margin     width="0" marginheight="0" hspace="0" vspace="0" border="0" style="height: 460px; width: 678px; " src="' + url + '.html' + queryParams + '" class="login_scrim_framedLifp" allowtransparency="true"></iframe></div></div></div>';

    	if((url.indexOf('emailreg') != -1)|| (url.indexOf('signin') != -1)|| (url.indexOf('account_status') != -1)){
        	var navText = navigator.userAgent.toLowerCase();
        	//console.log ('navigator-'+navText);
        	var browsVer = (navText.indexOf('msie') != -1) ? parseInt(navText.split('msie')[1]) : false;
        	if (browsVer && browsVer<=9)
        	{
        		var standParamRes = queryParams;
        		var queryParamsInd = queryParams.indexOf('?');
  	    	  	if(queryParamsInd != -1){
  	    	  		standParamRes = queryParams + '&pageEntry=standalone';
  	    	  	}else{
  	    	  		standParamRes = queryParams + '?pageEntry=standalone';
  	    	  
  	    	  	}

  	    	  	var urlParam = this.getCurrentUrl();
  	    	  	if(urlParam){
  	    	  		standParamRes = standParamRes + '&url=' + encodeURIComponent(urlParam);
  	    	  	}
  	    	  	
  	    	  	if (url.indexOf('account_status') != -1 && (status && status != '')) {
					standParamRes = standParamRes + '&djcs_status='+status;
					//console.log('arpu param for IE 8/9-'+standParamRes);
				}
  	    	  
        		//console.log ('Standalone for IE 9 or below...');
        		document.location.href = url + '.html' + standParamRes;
            	return;
        	} else
        	{
        		//queryParams = queryParams+'&pageEntry=scrim';
        		//console.log ('lanunchin scrim for this one: '+navText);
        		var scrimParamRes = queryParams;
        		var queryParamsInd = queryParams.indexOf('?');
  	    	  	if(queryParamsInd != -1){
  	    	  		scrimParamRes = queryParams + '&pageEntry=scrim';
  	    	  	}else{
  	    	  		scrimParamRes = queryParams + '?pageEntry=scrim';
  	    	  
  	    	  	}
  	    	  	if (url.indexOf('account_status') != -1 && (status && status != '')) {
  	    	  		var u1 = this.getCurrentUrl();
  	    	  		if(u1){
  	    	  			scrimParamRes = scrimParamRes + '&url=' + encodeURIComponent(u1);
  	    	  		}
  	    	  		scrimParamRes = scrimParamRes + '&djcs_status='+status;
  	    	  		//console.log('arpu param for scrim-'+scrimParamRes);
  	    	  	}
        		// need overlay fix- 
  	    	  	htmlContent='<style type="text/css">.login_scrim_wrapper1{display:table;position:fixed;height:100%;left:50%;top:18px;margin-left:-390px;margin-top:8px;z-index:9999999;border:0;}.login_scrim_inner1{display:table-cell;vertical-align:middle}.login_scrim_module_reg1{width:765px;line-height:1.15em;margin-left:10px}.login_scrim_framed1{display:block;border:0;padding:0;position:relative;width:100%!important;height:100%;z-index:100;top:-26px;border:0;}.login_scrim_module_reg1 .headerStrap_reg1{height: 6px;  padding: 15px 17px 0 0;  position: relative;  z-index: 101;  float: right;  margin-right: -5px; margin-top: -15px;}.email_reg_close1{border:0}@media only screen and (min-width:1025){.login_scrim_wrapper1{display:table;position:fixed;height:100%;left:50%;top:18px;margin-left:-390px;margin-top:8px;z-index:9999999}.login_scrim_framed1{display:block;border:0;padding:0;width:100%!important;height:100%;position:relative;z-index:100;top:-26px}}@media only screen and (min-width:551px) and (max-width:767px){.login_scrim_wrapper1{display:table;position:fixed;height:100%!important;left:50%;top:18px;margin-left:-284px;margin-top:8px;z-index:9999999}.login_scrim_inner1{display:table-cell;vertical-align:middle}.login_scrim_module_reg1{width:547px;line-height:1.15em;margin-left:10px}.login_scrim_framed1{display:block;border:0;padding:0;width:100%!important;height:100%;position:relative;z-index:100;top:-26px}.login_scrim_module_reg1 .headerStrap_reg1{height:0;padding:0 17px 0 0;position:relative;z-index:101;float:right;margin-top:-6px;margin-right:-5px;}.email_reg_close1{border:0}}@media only screen and (min-width:421px) and (max-width:550px){.login_scrim_wrapper1{display:table;position:fixed;height100%!important:;left:40%;top:18px;margin-left:-174px;margin-top:8px;z-index:9999999}.login_scrim_inner1{display:table-cell;vertical-align:middle}.login_scrim_module_reg1{width:411px;line-height:1.15em;margin-left:10px}.login_scrim_framed1{display:block;border:0;padding:0;width:100%!important;height:100%;position:relative;z-index:100;top:-26px}.login_scrim_module_reg1 .headerStrap_reg1{height:0;padding:0 12px 2px 0;margin-top:-6px;margin-right:0;position:relative;z-index:101;float:right}.email_reg_close1{border:0}}@media only screen and (max-width:420px){.login_scrim_wrapper1{display:table;position:fixed;height:100%!important;left:44%;top:18px;margin-left:-190px;margin-top:8px;z-index:9999999}.login_scrim_inner1{display:table-cell;vertical-align:middle}.login_scrim_module_reg1{width:410px;line-height:1.15em;margin-left:10px}.login_scrim_framed1{display:block;border:0;padding:0;width:100%!important;height:618px;position:relative;z-index:100;top:-26px}.login_scrim_module_reg1 .headerStrap_reg1{height:0;padding:0 12px 2px 0;margin-top:-6px;margin-right:0;position:relative;z-index:101;float:right}.email_reg_close1{border:0}}</style><div id="overlayDiv" class="login_scrim_wrapper1" style="opacity: 1; "><div id="login_inner" class="login_scrim_inner1"><div id="module" class="login_scrim_module_reg1"><div id="iframe_headerStrap" class="headerStrap_reg1"><a href="javascript:LIFP.closeScrim();"><img src="https://id.wsj.com/access/pages/wsj/us/img/close.png" class="email_reg_close1" alt="Close"></a></div><iframe id="lifp_iframe"  name="lifp_iframe" scrolling="no" frameborder="0" marginwidth="0" marginheight="0" hspace="0" vspace="0" border="0" style="height: 618px; width: 678px; " src="' + url + '.html' + scrimParamRes + '" class="login_scrim_framed1" allowtransparency="true"></iframe></div></div></div>';

        	}
    			
    	}
    	//console.log('in library with URL-'+url);
      if(this.isMobile.any()) {
    	//if(url.indexOf('emailreg') != -1){
    	if((url.indexOf('emailreg') != -1)|| (url.indexOf('signin') != -1)|| (url.indexOf('account_status') != -1)){
    		//if(!this.isMobile.iPad()) {
    			var mobParamRes = queryParams;
        		var queryParamsInd = queryParams.indexOf('?');
  	    	  	if(queryParamsInd != -1){
  	    	  		mobParamRes = queryParams + '&pageEntry=standalone';
  	    	  	}else{
  	    	  		mobParamRes = queryParams + '?pageEntry=standalone';
  	    	  	}
  	    	  	var urlParam = this.getCurrentUrl();
  	    	  	if(urlParam){
  	    	  		mobParamRes = mobParamRes + '&url=' + encodeURIComponent(urlParam);
  	    	  	}
  	    	  	
  	    	  	if (url.indexOf('account_status') != -1 && (status && status != '')) {
  	    	  		mobParamRes = mobParamRes + '&djcs_status='+status;
					//console.log('arpu param for mobile-'+mobParamRes);
				}
  	    	    document.location.href = url + '.html' + mobParamRes;
            	return;
    		//}
    		//document.location.href = url + '_standalone.html' + queryParams;
    		//document.location.href = url + queryParams;
    	}else{
        ...
        if(this.iframeContainer) {
          ...
          if(typeof(dojo) != 'undefined') {
            //console.log('dojo iframe');
            //this.iframeContainer = dojo.create('div', {innerHTML: htmlContent, "class":"login_overlay", id : "getGreyBckgroundCSSDiv" }, document.body);
            this.iframeContainer = dojo.create('div', {innerHTML: htmlContent,style: "position: fixed;width: 100%;height: 100%;z-index: 9999999;font-size: 10px;line-height: 10px;background: url('https://id.wsj.com/access/pages/wsj/us/img/login_overlay_bg.png') repeat;top: 0px;left: 0px;", id : "getGreyBckgroundCSSDivLifp"}, document.body);
            this.iframe = dojo.byId('lifp_iframe');
          } else {
            //console.log('non-dojo iframe');
            //this.iframeContainer = jQuery("<div/>", {html: htmlContent, "class":"login_overlay", id : "getGreyBckgroundCSSDiv" }).appendTo('body')[0];
            this.iframeContainer = jQuery("<div/>", {html: htmlContent, style: "position: fixed;width: 100%;height: 100%;z-index: 9999999;font-size: 10px;line-height: 10px;background: url('https://id.wsj.com/access/pages/wsj/us/img/login_overlay_bg.png') repeat;top: 0px;left: 0px;", id : "getGreyBckgroundCSSDivLifp" }).appendTo('body')[0];
    ...
    getUrlParam : function(name) {
     ...
     isMobile: {
        ...
        any: function() {
            return (this.Android() || this.BlackBerry() || this.iOS() || this.Windows() || this.iPad());
        }
    },
    ...
    login : function(msg, attr, nlc) {
    	if (this.signatureID != null && (typeof(this.signatureID) != 'undefined')&&((this.signatureID =='509b1a086458232f6e000002')||(this.signatureID =='50f5723cbd7fb2d2f6629af4')||(this.signatureID =='50f57257bd7fb2d2f6629af5')||(this.signatureID =='50f57264bd7fb2d2f6629af6')||(this.signatureID =='50539a1d13decf6d45000001')||(this.signatureID == '507f41447803c67206000002'))) {
    ...
    loginEmail : function(nlCode) {
    	//console.log('Calling loginEmail with code...'+nlCode);
    ...
    registerEmail : function(nlCode) {
    	//console.log('Calling loginEmail with code...'+nlCode);
    	//console.log('or this is the function?');
	...
	//Check and launch Account Status scrim
	checkStatus : function(){
		//console.log('checking account status');
		// lock down display for WSJ English editions only
		if (this.signatureID != null && (typeof(this.signatureID) != 'undefined')&&((this.signatureID =='50f5727cbd7fb2d2f6629af8')||(this.signatureID =='50f57272bd7fb2d2f6629af7')||(this.signatureID =='509b1a086458232f6e000002')||(this.signatureID =='50f57264bd7fb2d2f6629af6')||(this.signatureID =='507f41447803c67206000002')||(this.signatureID =='50f5723cbd7fb2d2f6629af4')||(this.signatureID == '50f57257bd7fb2d2f6629af5'))) {
			// fix for race condition, we will validate values before popping scrim
			var djSt = LIFP.getCookie("djcs_status");
			if (djSt != 'undefined' && djSt != '' && (djSt === 'cc-failure' || djSt === 'cc-hard-decline' || djSt === 'cc-near-expiry' || djSt === 'cc-expired' || djSt === 'ac-issue')) {
				//console.log('got status'+djSt);				
				LIFP.createIFrame('account_status', null, null, null, null, null, null, djSt);
			}
		}			
	},
